...
const educationHashMap = {
  courses: {
    data: ['School of computing', 'School of business and law', 'School of tourism and hospitality', 'School of engineering', 'School of languages', 'School of life science'],
    msgType: 'table-simple',
    emotion: 1
  },
  computing: {
    data: ['Certificate course',  'Hnd course',  'Diploma course',  'Undergraduate course', 'Post graduate course', 'Doctoral course'],
    msgType: 'table-simple',
    emotion: 1
  },
  businessandlaw: {
  ...
  Faculties: {
    data: ['IT Lab', 'Networking practical Lab', 'library', 'Network practical Lab', ' A/C Class Rooms', 'Auditorium', 'Sports', 'GYM'],
    msgType: 'table-simple',
    emotion: 1
  },
